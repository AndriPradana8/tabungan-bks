                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="login" name="login" value="{{ old('login') }}" required autofocus autocomplete="username"
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" placeholder="Masukkan username"/>
                                    ...
                                    <div>
                                        ...
                                        <div x-data="{ showPassword: false }" class="relative">
                                            ...
                                            <span @click="showPassword = !showPassword"
                                                ...
                                                <i class="fa-regular fa-eye" :class="showPassword ? 'fa-eye' : 'fa-eye-slash'"></i>
                                            </span>
                                        </div>
