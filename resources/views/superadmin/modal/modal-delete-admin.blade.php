<!-- Modal Delete Admin -->
<x-ui.modal @close-modal-delete-admin.window="open = false" :isOpen="false" :blurBackdrop="false" :showCloseButton="false" class="max-w-[400px] p-6 text-center">
    <div x-data="{ deleteData: {} }" @open-modal-delete-admin.window="open = true; deleteData = $event.detail">
        <h4 class="text-xl font-bold text-gray-800 dark:text-white mb-2">Hapus Admin?</h4>
        ...
        <div class="flex justify-center gap-3">
            ...
            <form :action="`/superadmin/admin/${deleteData.id}`" method="POST" class="m-0 p-0">
                @csrf
                @method('DELETE')
